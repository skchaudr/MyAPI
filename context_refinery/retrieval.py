...
class ResultReranker:
    ...
    def rerank(self, results, intent="factual", query=None):
        ...
        # Collect tags and build an inverted index (tag_to_docs) to optimize reinforcement scoring from O(N²) to O(N)
        tag_to_docs = {}
        all_tags = []
    ...
    def _reinforcement_score(self, index, all_tags, tag_to_docs):
        ...
        overlap_count = len(overlapping_docs) - (1 if index in overlapping_docs else 0)
