...
## 2026-08-06 - Overly Permissive CORS Policy
**Vulnerability:** Hardcoded overly permissive CORS policy including 0.0.0.0.
**Learning:** Hardcoding dev URLs is a poor practice for production environments.
**Prevention:** Read allowed origins from an environment variable and avoid wildcard addresses.
