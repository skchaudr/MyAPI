...
## 2026-07-30 - FastAPI Exception Handling Improvement
**Vulnerability:** Raw exception strings were returned to clients.
**Learning:** Default exception handling exposes internal details.
**Prevention:** Implement consistent error masking and log with exc_info=True.
